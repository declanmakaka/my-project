...
function findStrategy() {
  ...
  } else if (strategy.toLowerCase() === "organic or food waste") {
  ...
  } else if (strategy.toLowerCase() === "electronics or electronic waste") {
  ...
  } else if (strategy.toLowerCase() === "clothes or clothing waste") {
